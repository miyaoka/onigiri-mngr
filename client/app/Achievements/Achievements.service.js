  ...
  .factory('Achievements', function (toaster, Time) {
    ...
    var Achievements = {
      list : [
        ...
        { id: 'rice3', title : '明日の実り', desc : '米6㌧購入' },
        { id: 'rice4', title : '龍錦の素顔', desc : '米9㌧購入' },
        { id: 'rice5', title : 'ファーマー', desc : '米12㌧購入' },
        { id: 'rice6', title : 'なないろの味', desc : '米15㌧購入' },
        ...
        { id: 'money1', title: '与', desc: '1億円稼ぐ' },
        { id: 'money2', title: '沢', desc: '10億円稼ぐ' },
        { id: 'money3', title: '翼', desc: '100億円稼ぐ' }
